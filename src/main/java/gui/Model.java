...
public class Model {
    ...
    public void setExperience(int experience) { this.experience = new SimpleIntegerProperty(experience); }

    public String getCv_link() { return cv_link.get(); }

    public void setCv_link(String cv_link) { this.cv_link.set(cv_link); }

    public String getSkills() { return skills.get(); }

    public void setSkills(String skills) { this.skills = new SimpleStringProperty(skills); }
    ...
    public void setUser(String user) { this.user = new SimpleStringProperty(user); }
    ...
    public void setCv_date(String cv_date) { this.cv_date = new SimpleStringProperty(cv_date); }

    public String getCan_location() { return can_location.get(); }

    public void setLocation(String location) { this.can_location = new SimpleStringProperty(location); }

    public String getReferral() { return referral.get(); }

    public void setReferral(String referral) { this.referral = new SimpleStringProperty(referral); }

    public int getPhone() { return phone.get(); }

    public void setPhone(int phone) { this.phone = new SimpleIntegerProperty(phone); }
}